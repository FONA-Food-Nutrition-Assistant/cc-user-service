...
export class ExampleController {
	...
	@Get('fona-members-add')
	async createFonaMembersWithLearningPath(@Res() res: FastifyReply) {
		const data = await this.exampleService.createFonaMembersWithLearningPath();
		return new TidyResponse(HttpStatus.OK, ResponseMessage.OK, data);
	}
}
